 ...
 <div class="row">
            ...
            <div class="col-lg-12">
               <?php 
			       ...
			       $query="select * from product_info WHERE prod_category='South Indian Food'  LIMIT $limit,8";
				   ...
				   echo "<div class='col-lg-12 ' style=' margin-top:5px;height:20px'>";
			              ...
			              echo"<div class='row'>";
							...
							{
							    $limit-=8;
								echo"<span onClick='loadSouthindianProduct($limit)' 
